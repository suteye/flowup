...
-- CreateEnum
CREATE TYPE "NotificationProvider" AS ENUM ('TELEGRAM', 'LINE');
...
-- CreateIndex
CREATE UNIQUE INDEX "Space_workspaceId_key_key" ON "Space"("workspaceId", "key");
...
-- CreateIndex
CREATE UNIQUE INDEX "NotificationIntegration_workspaceId_provider_key" ON "NotificationIntegration"("workspaceId", "provider");
...
-- AddForeignKey
ALTER TABLE "NotificationIntegration" ADD CONSTRAINT "NotificationIntegration_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE CASCADE ON UPDATE CASCADE;
